...
print("Welcome to this financial program")
desc = int(input("Would you like to (0) graph a companies performance in a certain time interval \n,"
                 "or (1) determine if your portfolio is risky/pricey as per your standards?"))
